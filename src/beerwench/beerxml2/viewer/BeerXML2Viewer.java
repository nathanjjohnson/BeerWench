...
public class BeerXML2Viewer {
    ...
    private void initialize() {
        ...
        springLayout.putConstraint(SpringLayout.NORTH, tabbedPane, 124, SpringLayout.SOUTH, toolBar);
        springLayout.putConstraint(SpringLayout.WEST, tabbedPane, 204, SpringLayout.WEST, frmBeerxmlRecipeEditor.getContentPane());
